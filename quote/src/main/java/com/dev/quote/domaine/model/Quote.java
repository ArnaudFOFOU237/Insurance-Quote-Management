...
public class Quote {
    ...
    public Quote( UUID id, ClientId clientId, QuoteStatus status, ProductType productType, PercentageInsure percentageInsure, CapitalInsure capitalInsure, int lifeTime) {
        this.id = id;
    ...
    public void validate() {
        ...
        if (clientId == null) {
            throw new InvalidInputException("Client Id ne doit pas être nul");
        }
    }
}
